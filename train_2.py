...
from model.FDAFFNet import FDAFFNet,FDDAFFNet_C3Net,FDDAFFNet_X
from othermodels.FC_Siam_conc import SiamUnet_conc
from othermodels.FC_Siam_diff import SiamUnet_diff
...
summary_name = r"weights\polyu\Levir_cd\ourX\log"
csvpath = r"weights/polyu/Levir_cd\ourX/loss.csv"
model_dir = r"weights/polyu/Levir_cd\ourX/"
...
val_a_dir = r"Levir_CD_256\test\A"
val_b_dir = r"Levir_CD_256\test\B"
val_label_dir = r"Levir_CD_256\test\label"
'''
...
model_dir1 = r'weights\polyu\Levir_cd\ourX\epoch_ 60_best_loss_loss_0.696284_iou_82.175718.pth'
...
optimizer = torch.optim.Adam(net.parameters(), lr=0.0001, betas=(0.9, 0.999), eps=1e-08, weight_decay=0.0001)
'''
